...
SectionSummarizerSettingsDialog.prototype.getSetupProcess = function (data) {
    data = data || {};
    return SectionSummarizerSettingsDialog.super.prototype.getSetupProcess.call(this, data).next(
        function () {
...
SectionSummarizerSettingsDialog.prototype.getActionProcess = function (action) {
    ...
    return SectionSummarizerSettingsDialog.super.prototype.getActionProcess.call(this, action);
};
